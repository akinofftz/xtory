...
<xsl:template match="/xtory:story">
	<root>
		...
		<layout-master-set>
			...
			<!-- Seite mit Titel (Seite 3) -->
			<simple-page-master master-name="text-title" margin-right="15mm" margin-left="25mm" xsl:use-attribute-sets="page-size">
				<region-body region-name="main" margin-top="102mm" column-count="2" column-gap="1cm" />
				<region-before extent="100mm" region-name="title"/>
			</simple-page-master>

			<!-- Seite mit Impressum (Seite 4) -->
			<simple-page-master master-name="text-and-imprint" margin-right="25mm" margin-left="15mm" xsl:use-attribute-sets="page-size">
				<region-body region-name="main" margin-top="12mm" margin-bottom="32mm" column-count="2" column-gap="10mm" />
				<region-before extent="10mm" region-name="head-even"/>
				<region-after region-name="imprint" extent="30mm"/>
			</simple-page-master>

			<!-- Seite mit Rückblick (Seite 5) -->
			<simple-page-master master-name="text-and-preface" margin-right="15mm" margin-left="25mm" xsl:use-attribute-sets="page-size">
				<region-body region-name="main" margin-top="12mm" margin-bottom="72mm" column-count="2" column-gap="1cm" />
				<region-before extent="10mm" region-name="head-odd"/>
				<region-after extent="70mm" region-name="preface"/>
			</simple-page-master>
			...
			<page-sequence-master master-name="xtory">
				...
				<!-- Text und Impressum -->
				<single-page-master-reference master-reference="text-and-imprint"/>
				<!-- Text und Einleitung -->
				<xsl:if test="xtory:prefix/xtory:preface">
					<single-page-master-reference master-reference="text-and-preface"/>
				</xsl:if>
			...
			<page-sequence master-reference="cover">
				<flow flow-name="main">
					<block width="210mm" height="297mm" text-align="center" margin-top="0" margin-left="0">
						<external-graphic src="{$url}/{@xtory:id}.svg" content-width="210mm" content-height="297mm"/>
					</block>
		...
		<page-sequence master-reference="xtory">
			...
			<static-content flow-name="imprint">
				<block font-size="8pt" font-family="sans-serif" text-align="justify"
						border="0.1pt solid black" padding="10pt">
...
<!--				<xsl:if test="xtory:meta/xtory:cover">
					<table table-layout="fixed" width="100%" break-after="odd-page">
						<table-column column-width="proportional-column-width(1)"/>
						<table-body>
							<table-row height="297mm">
								<table-cell display-align="center">
									<block text-align="center">
										<external-graphic src="{$url}/{@xtory:id}.svg" width="210mm" height="297mm"/>
									</block>
								</table-cell>
							</table-row>
						</table-body>
...
<xsl:template match="xtory:preface">
	<static-content flow-name="preface">
		<block border="0.5pt solid black" font-family="sans-serif" font-size="11pt" padding="1em" margin="0" vertical-align="bottom">
			<block text-align="center" space-after="1em" font-weight="bold" font-size="12pt">
				<xsl:choose>
...
<xsl:template match="xtory:characters">
	<block-container font-family="sans-serif" font-size="10pt"
			space-after.minimum="0.5em" space-after.optimum="1em" space-after.maximum="3em"
			border="0.5pt solid black" padding="1em">
		<block font-size="11pt" font-weight="bold" text-align="center" space-after="1em">
			<xsl:choose>
...
<xsl:template match="xtory:characters/xtory:role">
	<block space-after="0.5em" start-indent="2em" text-indent="-2em" text-align="justify">
...
<xsl:template match="xtory:commentary">
	<page-sequence master-reference="appendix">
...
<xsl:template match="xtory:preface/html:p">
	<block font-family="sans-serif" font-size="10pt" text-align="justify">
		<xsl:apply-templates/>
	</block>
</xsl:template>
...
<xsl:template match="html:img">
	<external-graphic width="100%" src="{$url}{@src}"/>
</xsl:template>
